		...
		<>
			<div className="my-12 sm:ms-0 lg:-ms-10 p-4">
				<div className="flex justify-between mt-8 px-4">
					...
					<NavLink to="/see-all" className="text-blue-600">
						See all
					</NavLink>
				</div>
					...
					<div className="grid grid-cols-4">
						...
						<div className="mt-11">
							<div className="my-3 hidden md:block">
								<div className="addUserStoryImageBackground"></div>
								<div className="userStoryImageLogo">
									<img
										...
										alt="user_logo"
										className="h-12 w-12 rounded-full border-2 border-white ms-5 "
									/>
									<div>
										<button
											data-modal-target="AddStoryModal"
											data-modal-toggle="AddStoryModal"
										>
									...
									<p className="text-white py-2 text-sm bg-gray-400 w-42 addUserImageTextOfStories">
										Add Your Story{" "}
									</p>
								</div>
							</div>
						...
						<div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
							{[0, 1, 2].map((index) => (
								<div className="mt-11" key={index}>
									<div className="my-3">
										<div
											className="UserStoryImageBackground"
											style={{
												backgroundImage: `url(${"https://w0.peakpx.com/wallpaper/265/481/HD-wallpaper-nature.jpg"})`,
											}}
										></div>
										<div className="userStoryImageLogo">
											<img
												...
												className="h-12 w-12 rounded-full border-2 border-white ms-5 "
											/>
											<p className="text-white py-2 text-sm bg-gray-400 w-42 userImageTextOfStories">
												{" "}
												Natural hd picture{" "}
											</p>
										</div>
