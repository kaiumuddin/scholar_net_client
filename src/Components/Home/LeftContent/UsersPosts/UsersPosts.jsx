                ...
                <div>
                  ...
                  <div className='flex justify-around'> <p>Like</p> <i className="fa-regular fa-thumbs-up mx-2 text-lg mx-2 -mt-1"></i> </div>
                    ...
                    <button
                      ...
                      onClick={() => setShowShareLink(showShareLink === false ? true : false)}
                    >
                ...
                <>
                  {
                    [0, 1, 2, 3].map((index) =>
                      <div key={index} className='mt-6 mb-10'>
                        ...
                        <p className='comment text-sm text-gray-400 w-86'>This is a nich planning I think we should to obey this.
                          This is a nich planning I think we should to obey this.
                          This is a nich planning I think we should to obey this.
                          This is a nich planning I think we should to obey this.
                          This is a nich planning I think we should to obey this.
                        </p>
                ...
                showShareLink && <>  {
                  <div className='-mt-5'>
                    <CopyToClipboard text={`${' https://flowbite.com/docs/forms/toggle/#disabled-state'}`}>
                      <p onClick={() => setCopyStatus(true)} className='hover:cursor-pointer mb-2'>
                       { copyStatus ? <p className='text-green-600 text-md'> Copied !!</p> :  <i class="fa-regular fa-copy text-2xl text-green-600"></i>}
                        </p>
                    </CopyToClipboard>
