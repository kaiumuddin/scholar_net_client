...
const UsersPosts = () => {
  ...
  const items = [
    { content: "I love your comment" },
    { content: "I love your comment" },
    { content: "I love your comment" },
    { content: "I love your comment" },
    { content: "I love your comment" },];
  //store your data here in the state 
  const [isToggledOnCommment, setIsToggledOnCommment] = useState([]);
  const [isToggledOnShare, setIsToggledOnShare] = useState([]);
  const [commentText, setCommentText] = useState("") ;
  //toggle comment 
  function handleToggleComment(index) {
    setIsToggledOnCommment(prevState => {
  ...
  //toggle share 
  function handleToggleShare(index) {
    setIsToggledOnShare(prevState => {
      const newState = [...prevState];
      newState[index] = !newState[index];
      return newState;
    });
        ...
        <div key={index}>
          ...
          <div className="w-full md:max-w-2xl   ms-52 md:ms-0 mt-5 mb-3" key={index}>
            <Card>
                ...
                <div className="flex justify-between flex-col md:flex-row">
                  <div>
                    ...
                    <div className="mt-4 flex flex-col md:flex-row space-x-3 lg:mt-6">
                      ...
                      >
                        <div className='flex justify-around'> <p>Like</p> <i className="fa-regular fa-thumbs-up  text-lg mx-2 -mt-1"></i> </div>
                      </button>

                      <div>
                        <button onClick={() => handleToggleComment(index)}
                        title="Click to open comment and again click to close comment"
                      ...
                      <button
                        ...
                        title="Click to open share and again click to close share"
                      >
                  ...
                  <div className='mx-8'>
                    <div className=' -ms-5 md:ms-12 mt-8'>  Replay <i className="fa-solid fa-reply-all mx-2 mb-12 text-lg"></i></div>
                    <div className="flex justify-center">
                      <div className="hover:cursor-pointer">
                        <React.Fragment>
                          <div className={`flex justify-between ms-7 -mt-8  md:block ${`hidden`}`}>
                            <Avatar.Group>
                              <Avatar
                                img={like}
                                rounded={true}
                      ...
                      <p className='mx-3 -mt-5 text-gray-600'> 30+ </p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="commentSection -mt-5">
                    <form >
                      <div id="textarea">
                        ...
                        />
                        {/* use here id insted  of index */}
                        <button value={index} onClick={(e) => submitCommentData(e)} className='text-white bg-gradient-to-r  ps-3  mt-5 from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-full text-sm  px-2 py-1 pb-2 text-center mr-2 mb-5'> Send comment <i className="fa-solid fa-paper-plane mx-2 text-white text-lg"></i> </button>
                      </div>
                    </form>
                    ...
                    <>
                      {
                        ...
                        [0, 1, 2, 3].map((index) =>
                          <div key={index} className='mt-6 mb-10'>
                            ...
                            <div className="flex font-bold  my-5">
                              <img src="https://i.ibb.co/q7MNxRK/g3.jpg" alt="user profile" className='h-10 w-11 rounded-full border-2 border-green-500' />
                              <div className="flex flex-col mx-2">
                                <p className='text-lg text-blue-600'> Linda smith  <span className='text-gray-400 text-sm -mt-2'>post date: 04/03/2023</span> </p>
                              </div>
                            </div>
                     <p className='comment text-sm text-gray-400 w-86'>  {item.content}</p>
              ...
              <>
                {
               isToggledOnShare[index] &&   <>  {
                    <div className='-mt-5'>
                      <CopyToClipboard text={`${' https://flowbite.com/docs/forms/toggle/#disabled-state'}`}>
                        <div className='hover:cursor-pointer mb-2'>
                          { isToggledOnCopy[index]   ? <p className='text-green-600 text-md'> Copied !!</p> : <i className="fa-regular fa-copy text-2xl text-green-600"  onClick={() => handleToggleCopy()}></i>}
                        </div>
                      </CopyToClipboard>
                      <a href="https://flowbite.com/docs/forms/toggle/#disabled-state" className='text-blue-400 text-md' target="_blank" rel="noopener noreferrer">
                        https://flowbite.com/docs/forms/toggle/#disabled-state
                      </a>
                      <p className='my-3 text-gray-400 font-bold text-lg'> Copy this link to share with your friends.</p>
                    </div>
                  }
                  </>
                }
