...
const BooksSlider = () => {
  ...
  let items = [0, 1, 2, 3].map((index) => (
    <div key={index} className="h-42 w-32" style={{ height: "228px" }}>
      <div
        className="max-w-md border  border-gray-200 rounded-lg shadow p-2 -mt-12"
        style={{ width: "160px" }}
      >
        <div className="flex flex-col items-center pb-10">
          <img
            className="shadow-lg border-2"
            src="https://i.ibb.co/4Zjxn5y/g2.jpg"
            style={chatRoomDivUserImageStyle}
            alt="Bonnie_image"
          />
          <span className="text-md text-gray-500 dark:text-gray-400 my-3">
            Jhoan smith
          </span>
          <div
            className="dark:text-gray-400 my-3 flex -mt-3 text-blue-600"
            style={{ fontSize: "12px" }}
          >
